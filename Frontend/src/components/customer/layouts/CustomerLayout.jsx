...
const CustomerLayout = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAF7] text-[#2C1A0E]" style={shellFont}>
      <aside className="fixed inset-y-0 hidden w-64 flex-col border-r border-[#EDE8DF] bg-white/95 backdrop-blur md:flex">
          ...
          {NAV_ITEMS.slice(0, 4).map((item) => {
            ...
            return (
              <button
                ...
                className={`relative flex w-full items-center gap-3 px-6 py-3 text-left text-sm transition ${active
        ...
        <div className="mt-auto border-t border-[#F2EDE4] px-6 py-5">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-[12px] border border-[#EFD7B3] bg-[#FFF4E2] px-4 py-2.5 text-sm font-semibold text-[#B8641A] transition hover:bg-[#FCE8CB]"
          >
            <QrCode size={16} />
            My QR Code
          </button>
          ...
          <button
            ...
            className="mt-3 flex w-full items-center justify-center gap-2 rounded-[12px] border border-[#EDE8DF] px-4 py-2.5 text-sm font-semibold text-[#B89970] transition hover:border-[#F5C6C4] hover:bg-[#FDF6EC] hover:text-[#C0392B]"
          >
            <LogOut size={16} />
            Logout
          </button>
      ...
      <main className="flex-1 pb-[calc(env(safe-area-inset-bottom)+88px)] md:ml-64 md:pb-0">
