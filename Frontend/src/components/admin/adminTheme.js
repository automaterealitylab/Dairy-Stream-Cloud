...
export const adminTheme = {
  ...
  panel: "bg-white/95 border border-[#EDE8DF] shadow-[0_18px_45px_rgba(92,61,30,0.08)] dark:bg-[#121829] dark:border-[#1E293B] dark:shadow-[0_18px_45px_rgba(0,0,0,0.3)]",
  mutedPanel: "bg-[#FFFDF8] border border-[#F2EDE4] dark:bg-[#161C2C] dark:border-[#222B40]",
