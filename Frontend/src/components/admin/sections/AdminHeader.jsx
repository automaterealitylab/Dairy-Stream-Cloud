      ...
      <div className="mt-3 flex flex-wrap items-center gap-4">
        ...
        <div className="relative hidden lg:block">
          <button 
            ...
            className="relative p-2.5 rounded-2xl border border-[#EDE8DF] bg-white hover:bg-[#FDF6EC] text-[#B89970] hover:text-[#B8641A] transition focus:outline-none shadow-sm flex items-center justify-center dark:border-[#1E293B] dark:bg-[#121829] dark:text-slate-400 dark:hover:text-[#00C896]"
            title="Notifications"
          >
            <Bell size={22} />
            {unreadCount > 0 && (
